...
public class ActivityBasketData extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		TabHost tabHost = (TabHost) findViewById(R.id.tabsBasket);
		tabHost.setup();
		...
		spec.setIndicator(getString(R.string.teamA));
		spec.setContent(R.id.tab2);
		tabHost.addTab(spec);
		
		//Teams Tab Setup
		spec = tabHost.newTabSpec("tab2");
		spec.setIndicator(getString(R.string.teamB));
		spec.setContent(R.id.tab3);
		tabHost.addTab(spec);
		
		//Start Tab Setup
		spec = tabHost.newTabSpec("tab4");
		spec.setIndicator(getString(R.string.start));
		spec.setContent(R.id.tab4);
		tabHost.addTab(spec);
		
		//Actions for the player dialog
		processingPlayer();
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		//getMenuInflater().inflate(R.menu.activity_basket_data, menu);
		return true;
	}
